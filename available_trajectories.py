available_trajectories = {
    ...
    "pHomePosition": [
        ...
        "tHomePosition_To_HomePositionWithSomeCargo",
    ],
    "pHelicopterModule": [
    ...
    "pHelicopter2Charger1BeforeSlot1": [
        ...
        "tHelicopter2Charger1BeforeSlot1_To_Helicopter2Charger1WithBatt",
    ],
    ...
    "pHelicopter2Charger1BeforeSlot2": [
        ...
        "tHelicopter2Charger1BeforeSlot2_To_Helicopter2Charger1WithBatt",
    ],
    "pVTOL2Charger1": [
    ...
    "pVTOL1BeforeBatterySlot": [
        ...
        "tVTOL1BeforeBatterySlot_To_VTOL1WithSomeCargo",
    ],
    "pVTOL2": [
    ...
    "pVTOL2BeforeBattery1Slot": [
        ...
        "tVTOL2BeforeBattery1Slot_To_VTOL2WithBatt",
    ],
    "pVTOL2Battery2": [
    ...
    "pVTOL2BeforeBattery2Slot": [
        ...
        "tVTOL2BeforeBattery2Slot_To_VTOL2WithBatt",
    ],
