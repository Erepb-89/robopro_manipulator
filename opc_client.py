...
class ManipulatorPoints:
    ...
    x_module_h: bool = True  # commissioning
    y_module_h: bool = True  # commissioning
    x_module_v: bool = True  # commissioning
    y_module_v: bool = True  # commissioning
    x_charge_h: bool = True  # commissioning
    y_charge_h: bool = True  # commissioning
    x_charge_v: bool = True  # commissioning
    y_charge_v: bool = True  # commissioning
